...
const MSNScenes = (() => {
  ...
  // ------------------------------------------------------------
  // Planos de fundo de CONVERSA (galeria própria, assets/backgrounds/
  // fundoN.webp) — catálogo separado dos 23 cenários acima: aqueles
  ...
  return {
    ...
    chatBackgrounds: CHAT_BACKGROUNDS, findChatBackground, chatBackgroundBg,
  };
})();
